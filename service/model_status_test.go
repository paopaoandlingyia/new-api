...
func TestMergeModelStatusesUsesCatalogAsSource(t *testing.T) {
	pricing := []model.Pricing{
		{ModelName: "model-b", Description: "B"},
		{ModelName: "model-a", Description: "A"},
	}
	...
	public := mergeModelStatuses(pricing, items, false)
	...
	managed := mergeModelStatuses(pricing, items, true)
